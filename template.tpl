...
[
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "If you choose \"Initialize publisher script\", the tag will only download the SDK (unless it\u0027s already downloaded). If you choose \"Track section view\", the tag will download the SDK (if necessary), and then track a section view with the ID you provide. \"Track page view\" should be used with Single-page Applications, where the publisher script doesn\u0027t automatically track the SPA page change."
  },
  {
    "type": "TEXT",
    "name": "sectionId",
...
if (data.tagType === 'trackPage') apl(['trackPageview']);
